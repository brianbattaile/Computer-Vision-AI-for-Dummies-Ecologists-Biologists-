...
for root, dirs, files in os.walk(r"G:\.shortcut-targets-by-id\1_IRSVwxHJ_lLPwru5DzDz_qUrVgKzri2\GS Census\Data\2022\SSS_2022\Sites\Yolov9\Water Column Present\100"):
    for file in files:
        if file.endswith(".png"):
            geotiff_paths.append(os.path.join(root, file))

detection_model = AutoDetectionModel.from_pretrained(
    model_type='yolov9hub',
    model_path='C:/Users/Green Sturgeon/AI_Project/AIvenv3.11YoloV9/Scripts/yolov9/runs/train/exp2/weights/best.pt',  #yolov9_model_path
...
for geotiff_path in geotiff_paths:
    ...
    output_geojson_path = f'{filename}N.geojson'
